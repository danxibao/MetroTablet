...
namespace Project_try
{
    ...
    public sealed partial class Register : Page
    {
        ...
        private void Accept_Click(object sender, RoutedEventArgs e)
        {
            ...
            passWord_Confirm.BorderBrush = new SolidColorBrush(Colors.White);
            if (string.IsNullOrWhiteSpace(passWord.Password))
            {
                passWord.BorderBrush = new SolidColorBrush(Colors.Red);
                Register_OK = false;
            }
            else if(passWord.Password == passWord_Confirm.Password)
            {
                User.Password = passWord.Password;
            }
            else
            {
                passWord_Confirm.BorderBrush = new SolidColorBrush(Colors.Red);
                Register_OK = false;
            }
